...
class User extends CI_Controller
{
    ...
    public function edit_lap_bulanan($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->db->set('alamat_penerima', $alamat_penerima);
    ...
    public function edit_lap_tahunan($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['title'] = 'Edit Surat Rekomendasi';
            $data['user'] = $this->db->get_where('mst_user', ['username' => $this->session->userdata('username')])->row_array();
    ...
    public function edit_lap_lain($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['title'] = 'Edit Madrasah Diniyah';
            $data['user'] = $this->db->get_where('mst_user', ['username' => $this->session->userdata('username')])->row_array();
    ...
    public function edit_dok_kerja($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $data['title'] = 'Edit Ijin Operasional';
            $data['user'] = $this->db->get_where('mst_user', ['username' => $this->session->userdata('username')])->row_array();
