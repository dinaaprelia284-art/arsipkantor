                    ...
                    <table class=" table table-bordered table-hover" id="table-id" style="font-size:14px;">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($scan_pendukung_saya as $sps) : ?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><?php echo $sps['nama']; ?></td>
                                    <td><?php echo $sps['nama_file']; ?></td>
                                    <td><?php echo $sps['file_upload']; ?></td>
                                    <td><?php echo format_indo($sps['date_upload']); ?></td>
                                    <td><a href="<?php echo base_url('admin/file_download_scan_pendukung/' . $sps['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Scan Berkas Pendukung</h3>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/scan_berkas_pendukung'); ?>
            ...
            <div class="modal-footer">
                <div class="pull-left text-muted">* Ekstensi File jpg, jpeg, png, dan gif</div><br>
