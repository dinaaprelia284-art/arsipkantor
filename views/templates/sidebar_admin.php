        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url('admin/lap_harian'); ?>"><i class="fa fa-circle-o"></i> Surat Masuk</a></li>
                    <li><a href="<?php echo base_url('admin/lap_bulanan'); ?>"><i class="fa fa-circle-o"></i> Surat Keluar</a></li>
                    <li><a href="<?php echo base_url('admin/lap_tahunan'); ?>"><i class="fa fa-circle-o"></i> Surat Rekomendasi</a></li>
                    <li><a href="<?php echo base_url('admin/lap_lain'); ?>"><i class="fa fa-circle-o"></i> Madrasah Diniyah</a></li>
                    <li><a href="<?php echo base_url('admin/dok_kerja'); ?>"><i class="fa fa-circle-o"></i> Ijin Operasional</a></li>
                </ul>
            </li>
