                        ...
                        <tbody>
                            ...
                            <?php foreach ($dok_kerja_saya as $dks) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $dks['tahun']; ?></td>
                                    <td><?php echo $dks['masa_berlaku']; ?></td>
                                    <td><?php echo $dks['kecamatan']; ?></td>
                                    <td><?php echo $dks['lpq']; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Ijin Operasional</h3>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Tahun</label>
                    <input type="number" class="form-control" name="tahun" placeholder="Masukkan Tahun (contoh: 2025)" min="2000" max="2100" required>
                </div>
                ...
                <div class="form-group">
                    <label>LPQ</label>
                    <input type="text" class="form-control" name="lpq" placeholder="Masukkan Nama LPQ" required>
                </div>
