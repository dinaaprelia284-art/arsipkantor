                        ...
                        <tbody>
                            ...
                            <?php foreach ($lap_harian_saya as $lhs) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $lhs['tanggal_surat']; ?></td>
                                    <td><?php echo $lhs['instansi']; ?></td>
                                    <td><?php echo $lhs['no_surat']; ?></td>
                                    <td><?php echo $lhs['perihal']; ?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Surat Masuk</h3>
            </div>
