                        ...
                        <tbody>
                            ...
                            <?php foreach ($lap_lain_saya as $lls) : ?>
                                <tr>
                                    ...
                                    <td><?php echo format_indo($lls['date_upload']); ?></td>
                                    <td><a href="<?php echo base_url('user/file_download_lain/' . $lls['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_lap_lain/' . $lls['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_lap_lain/' . $lls['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Madrasah Diniyah</h3>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/lap_lain'); ?>
