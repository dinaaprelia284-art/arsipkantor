                        ...
                        <tbody>
                            ...
                            <?php foreach ($lap_tahunan_saya as $lts) : ?>
                                <tr>
                                    ...
                                    <td><?php echo $lts['tanggal_surat']; ?></td>
                                    <td><?php echo $lts['alamat_penerima']; ?></td>
                                    <td><?php echo $lts['no_surat']; ?></td>
                                    <td><?php echo $lts['perihal']; ?></td>
                                    <td><a href="<?php echo base_url('user/file_download_tahunan/' . $lts['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_lap_tahunan/' . $lts['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_lap_tahunan/' . $lts['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Surat Rekomendasi</h3>
            </div>
